...
<html>
    <head>
        ...
        <title>Lista de Socio jurídicos</title>
        ...
        <script type="text/javascript" class="init">
            ...
            $(document).ready(function () {
                $('#sociojuridicos').DataTable();
            });
            function excluir(id, selo) {
                $('#delete').attr('href', 'del_sociojuridico.php?id=' + id);
                $('#nome_excluir').text(selo);
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4 border-primary" style="max-width:1200px">
                            <div class="row ml-0 card-header py-2 bg-gradient-primary" style="width:100%">
                                ...
                                <div class="col mb-0">
                                    <span style="align:left;" class="h5 m-0 font-weight text-white">Socio Jurídicos</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="sociojuridicos" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th scope="col">ID</th>
                                            ...
                                            <th scope="col" style="min-width:100px;">Opções</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php include './get_sociojuridico.php'; ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form_editar_selo" method="post" action="alterar_selo_sociojuridico.php">
                            ...
                            <input type="hidden" name="selo_atual" id="selo_atual">
